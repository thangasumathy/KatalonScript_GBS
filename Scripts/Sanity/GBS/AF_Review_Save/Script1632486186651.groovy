...
WebUI.setText(findTestObject('Page_DIR/input_Select product category'), 'cer')

WebUI.click(findTestObject('Page_DIR/span_Ceramic Capacitor'))

WebUI.selectOptionByValue(findTestObject('Page_DIR/select_Commodity'), 'Ceramic Capacitor', 
    true)

WebUI.verifyElementPresent(findTestObject('Page_DIR/div_Commodity code'), 2)

WebUI.setText(findTestObject('Page_DIR/input_Commodity Prefix_attr'), 'CAP')
